...
export interface WsRpcClient {
  ...
  readonly orchestration: {
    ...
    readonly getEpicWorkflowDetail: RpcUnaryMethod<
      typeof ORCHESTRATION_WS_METHODS.getEpicWorkflowDetail
    >;
    ...
    orchestration: {
      ...
      replayEvents: (input) =>
        transport
          ...
          .then((events) => [...events]),
      getEpicWorkflowDetail: (input) =>
        transport.request((client) =>
          client[ORCHESTRATION_WS_METHODS.getEpicWorkflowDetail](input),
        ),
