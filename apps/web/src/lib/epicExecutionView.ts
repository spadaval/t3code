...
function collectIssueTitles(epic: BeadsEpicWorkflowSnapshot): Map<string, string> {
...
export function buildEpicExecutionViewData(epic: BeadsEpicWorkflowSnapshot): EpicExecutionViewData {
