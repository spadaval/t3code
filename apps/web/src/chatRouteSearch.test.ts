...
describe("stripRightPaneSearchParams", () => {
  it("clears all right pane params while preserving unrelated search state", () => {
    expect(
      stripRightPaneSearchParams({
        rightPane: "issues",
        issueId: "TASK-101",
...
describe("buildIssueRightPaneSearch", () => {
  it("switches to the issues pane while preserving unrelated search state", () => {
    expect(
      buildIssueRightPaneSearch(
        {
          rightPane: "diff",
