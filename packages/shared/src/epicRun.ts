...
export type EpicWorkflowFetchSource = EpicRunCoordinatorFetchSource;
export type EpicWorkflowFetchFailure = EpicRunCoordinatorFetchFailure;
export const isEpicWorkflowFetchTimeoutMessage = isEpicRunCoordinatorFetchTimeoutMessage;
export const describeEpicWorkflowFetchFailure = describeEpicRunCoordinatorFetchFailure;
export type EpicWorkflowFetchLifecycleKind = EpicRunCoordinatorFetchLifecycleKind;
export type EpicWorkflowFetchLifecycle = EpicRunCoordinatorFetchLifecycle;
export type EpicWorkflowStateKind = EpicCoordinatorStateKind;
export type EpicWorkflowState = EpicCoordinatorState;
export const describeEpicWorkflowState = describeCoordinatorEpicState;
export const deriveEpicWorkflowState = deriveEpicCoordinatorState;
