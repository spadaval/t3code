...
export const PlanImplementationLaunchId = makeEntityId("PlanImplementationLaunchId");
export type PlanImplementationLaunchId = typeof PlanImplementationLaunchId.Type;
export const SwarmRunId = makeEntityId("SwarmRunId");
export type SwarmRunId = typeof SwarmRunId.Type;
export const SwarmTaskExecutionId = makeEntityId("SwarmTaskExecutionId");
export type SwarmTaskExecutionId = typeof SwarmTaskExecutionId.Type;
